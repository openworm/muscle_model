...
extern int nrn_get_mechtype();
 ...
 "trap0_k_slow", _hoc_trap0,
 "trates_k_slow", _hoc_trates,
 0, 0
};
#define trap0 trap0_k_slow
 extern double trap0();
...
#define k_reversal_potential k_reversal_potential_k_slow
 double k_reversal_potential = -12;
#define m_B_F m_B_F_k_slow
 double m_B_F = 18;
#define m_B_D m_B_D_k_slow
 double m_B_D = 0;
#define m_B_C m_B_C_k_slow
 double m_B_C = 0;
#define m_B_B m_B_B_k_slow
 double m_B_B = 0;
#define m_B_A m_B_A_k_slow
 double m_B_A = 4;
#define m_A_F m_A_F_k_slow
 double m_A_F = -10;
#define m_A_D m_A_D_k_slow
 double m_A_D = -25;
#define m_A_C m_A_C_k_slow
 double m_A_C = -1;
#define m_A_B m_A_B_k_slow
 double m_A_B = -0.1;
#define m_A_A m_A_A_k_slow
 double m_A_A = 2.5;
#define usetable usetable_k_slow
 double usetable = 1;
#define vmax vmax_k_slow
 double vmax = 120;
#define vmin vmin_k_slow
 double vmin = -30;
 ...
 "m_B_D_k_slow", "mV",
 "m_B_F_k_slow", "mV",
 "k_reversal_potential_k_slow", "mV",
 "vmin_k_slow", "mV",
 "vmax_k_slow", "mV",
 "gbar_k_slow", "pS/um2",
 "gk_k_slow", "pS/um2",
 ...
 "m_A_A_k_slow", &m_A_A_k_slow,
 "m_A_B_k_slow", &m_A_B_k_slow,
 "m_A_C_k_slow", &m_A_C_k_slow,
 "m_A_D_k_slow", &m_A_D_k_slow,
 "m_A_F_k_slow", &m_A_F_k_slow,
 "m_B_A_k_slow", &m_B_A_k_slow,
 "m_B_B_k_slow", &m_B_B_k_slow,
 "m_B_C_k_slow", &m_B_C_k_slow,
 "m_B_D_k_slow", &m_B_D_k_slow,
 "m_B_F_k_slow", &m_B_F_k_slow,
 "k_reversal_potential_k_slow", &k_reversal_potential_k_slow,
 "vmin_k_slow", &vmin_k_slow,
 "vmax_k_slow", &vmax_k_slow,
 "usetable_k_slow", &usetable_k_slow,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 k_slow /home/mike/dev/muscle_model/pyramidal_implementation/x86_64/k_slow.mod\n");
