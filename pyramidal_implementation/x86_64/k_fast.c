...
extern int nrn_get_mechtype();
 ...
 "trap0_k_fast", _hoc_trap0,
 "trates_k_fast", _hoc_trates,
 0, 0
};
#define trap0 trap0_k_fast
 extern double trap0();
...
#define h_B_F h_B_F_k_fast
 double h_B_F = -10;
#define h_B_D h_B_D_k_fast
 double h_B_D = -30;
#define h_B_C h_B_C_k_fast
 double h_B_C = 1;
#define h_B_B h_B_B_k_fast
 double h_B_B = 0;
#define h_B_A h_B_A_k_fast
 double h_B_A = 1;
#define h_A_F h_A_F_k_fast
 double h_A_F = 20;
#define h_A_D h_A_D_k_fast
 double h_A_D = 0;
#define h_A_C h_A_C_k_fast
 double h_A_C = 0;
#define h_A_B h_A_B_k_fast
 double h_A_B = 0;
#define h_A_A h_A_A_k_fast
 double h_A_A = 0.07;
#define m_B_F m_B_F_k_fast
 double m_B_F = 18;
#define m_B_D m_B_D_k_fast
 double m_B_D = 0;
#define m_B_C m_B_C_k_fast
 double m_B_C = 0;
#define m_B_B m_B_B_k_fast
 double m_B_B = 0;
#define m_B_A m_B_A_k_fast
 double m_B_A = 4;
#define m_A_F m_A_F_k_fast
 double m_A_F = -10;
#define m_A_D m_A_D_k_fast
 double m_A_D = -25;
#define m_A_C m_A_C_k_fast
 double m_A_C = -1;
#define m_A_B m_A_B_k_fast
 double m_A_B = -0.1;
#define m_A_A m_A_A_k_fast
 double m_A_A = 2.5;
#define na_reversal_potential na_reversal_potential_k_fast
 double na_reversal_potential = 115;
#define usetable usetable_k_fast
 double usetable = 1;
#define vmax vmax_k_fast
 double vmax = 120;
#define vmin vmin_k_fast
 double vmin = -30;
 ...
 "h_B_D_k_fast", "mV",
 "h_B_F_k_fast", "mV",
 "na_reversal_potential_k_fast", "mV",
 "vmin_k_fast", "mV",
 "vmax_k_fast", "mV",
 "gbar_k_fast", "pS/um2",
 "gna_k_fast", "pS/um2",
 ...
 "m_A_A_k_fast", &m_A_A_k_fast,
 "m_A_B_k_fast", &m_A_B_k_fast,
 "m_A_C_k_fast", &m_A_C_k_fast,
 "m_A_D_k_fast", &m_A_D_k_fast,
 "m_A_F_k_fast", &m_A_F_k_fast,
 "m_B_A_k_fast", &m_B_A_k_fast,
 "m_B_B_k_fast", &m_B_B_k_fast,
 "m_B_C_k_fast", &m_B_C_k_fast,
 "m_B_D_k_fast", &m_B_D_k_fast,
 "m_B_F_k_fast", &m_B_F_k_fast,
 "h_A_A_k_fast", &h_A_A_k_fast,
 "h_A_B_k_fast", &h_A_B_k_fast,
 "h_A_C_k_fast", &h_A_C_k_fast,
 "h_A_D_k_fast", &h_A_D_k_fast,
 "h_A_F_k_fast", &h_A_F_k_fast,
 "h_B_A_k_fast", &h_B_A_k_fast,
 "h_B_B_k_fast", &h_B_B_k_fast,
 "h_B_C_k_fast", &h_B_C_k_fast,
 "h_B_D_k_fast", &h_B_D_k_fast,
 "h_B_F_k_fast", &h_B_F_k_fast,
 "na_reversal_potential_k_fast", &na_reversal_potential_k_fast,
 "vmin_k_fast", &vmin_k_fast,
 "vmax_k_fast", &vmax_k_fast,
 "usetable_k_fast", &usetable_k_fast,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 k_fast /home/mike/dev/muscle_model/pyramidal_implementation/x86_64/k_fast.mod\n");
